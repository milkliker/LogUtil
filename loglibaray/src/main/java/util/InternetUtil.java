...
public class InternetUtil {
    ...
    public static boolean isOnline() {
        ConnectivityManager con = (ConnectivityManager) sApplication.getSystemService(Activity.CONNECTIVITY_SERVICE);
    ...
    public static int getNetWorkClass() {
        TelephonyManager telephonyManager = (TelephonyManager) sApplication
    ...
    public static int getNetWorkStatus() {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) sApplication
                .getSystemService(Context.CONNECTIVITY_SERVICE);
